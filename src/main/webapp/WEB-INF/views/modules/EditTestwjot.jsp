...
<script type="text/javascript" src="static/app/modules/edittestwjot.js"></script>
...
<body>
	<form id='edit-testwjot-form' class="iframe-form">
		<table class='iframe-table' align="center">
  				...
  				<tr>
				 	...
				 	<td  class="td-input">
				 	<select class="testwj iframe-radius iframe-select" name="testwj.id" style="width: 345px;" value='${entity.testwj.id}'>
					</select></td>
					<td></td>
				</tr>
