...
<div class = "main" id="a-demo-Main" >
 	...
 	<!-- <form class="FindData-form" id = "FindData-form">
		...
		<form  class="FindData-form" id = "FindData-form" >
			<div style='width: 160px;margin-left: auto;margin-right: auto;'>
			    ...
			    <label for="exampleInputEmail1">汽车编号1</label>
 ...
 <shiro:hasPermission name="user:create">
   ...
   <div class = "btn-container">
     	...
     	<button type="button" class="btn btn-info  add-demo">添加1</button>
     </div>
 ...
 <shiro:hasPermission name="user:delete">
  ...
  <shiro:hasPermission name="user:show">
   ...
   <shiro:hasPermission name="user:excel">
	...
	<table cellspacing="0" cellpadding="0" class="demo-table table-bordered-diy" id="track-table1"><!-- 这里识别用的是id， 自定义 -->
			<thead>
				<tr class='newTr'>
...
(function($, exports) {
	var TrackModule = new exports.Modle("a-demo-Main","trackmanagement","edittrack","track-table1","track");
	//debugger;
	//构建获取的每一行
