var name = "template";
var theUrl = "edittemplate";

$(document).ready(function() {
	var myAlidation = new checkIframe("edit-template-form",{});//初始化数据监测
	//初始化数据框
	var iframeAction = new AjaxIframe({moduleName:"template", formClassName:"iframe-form" });
