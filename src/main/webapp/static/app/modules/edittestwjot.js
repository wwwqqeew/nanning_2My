var name = "testwjot";
var theUrl = "edittestwjot";

$(document).ready(function() {
	var myAlidation = new checkIframe("edit-testwjot-form",{});//初始化数据监测
	//初始化数据框
	var iframeAction = new AjaxIframe({moduleName:"testwjot", formClassName:"iframe-form" });
	
	//myAlidation.init();
	//默认方法
	iframeAction.init();
	//外键开始
	iframeAction.findListAction("testwj");
	//外键结束
