package com.ritu.nanning.utils.email;
...
//        session.setDebug(true); //有他会打印一些调试信息。
     ...
     // 准备邮件数据
        ...
        text.setContent(new Date()+"  视频图片<img src='cid:xxx.jpg'>", "text/html;charset=UTF-8");
...
//        Transport transport = session.getTransport("smtp");
    ...
    public static boolean sendEmail(String imgUrl) throws Exception{
